...
/*
 Multi-line comment used to comment many lines at a time without putting // before each and every line.
*/

// Tells the compiler iostream library which allows the input and output functions in the program
#include <iostream>
